...
class DioRequestInspectorMain extends StatefulWidget {
  static const routeName = '/dio-request-inspector/dashboard';
  final String password;

  const DioRequestInspectorMain({Key? key, this.password = ''}) : super(key: key);

  @override
  State<DioRequestInspectorMain> createState() => _DioRequestInspectorMainState();
}

class _DioRequestInspectorMainState extends State<DioRequestInspectorMain> {
